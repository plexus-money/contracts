...
describe('Deploying the plexus contracts for WrapperUni CROSS-DEX remix test', () => {
  let wrapper, owner;
  let netinfo;
  let network = 'unknown';
  ...
  describe('Testing Uni V2 remixing liquidity', () => {
    ...
    it('Should do a CROSS-DEX remix from the (ETH-USDC) LP Token in UNI V2 to the (CRV-CVXCRV) LP Token in SUSHI', async () => {
